...
1)모듈디렉토리 생성
```
$ mkdir /jboss/was/jboss-eap-6.4/modules/system/layers/base/com/mysql/main
...
jar파일, module 파일은 jboss 계정으로 변경 한다.
...
#Driver 목록확인
```
[standalone@192.168.190.161:9999 /] /subsystem=datasources:installed-drivers-lis[standalone@192.168.101.158:9999 /] /subsystem=datasources:installed-drivers-list
{
    "outcome" => "success",
    "result" => [
        {
