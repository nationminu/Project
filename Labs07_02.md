...
```
INFO  [org.apache.tomcat.util] (ajp-/10.10.10.10:8009-Acceptor) JBWEB003008: Maximum number of threads (512) created for connector with address /10.10.10.10 and port 8009
```
